...
//    symbols = prompt('enter some text')
//    let newString = text.replace(`${symbols}, ''`);;
//    return newString;
// }

// const chengeString = removeSymbols()

// console.log(chengeString)
debugger
let newString = 'text';
let symbol = 'e, t'
let changeNewString = newString.replace(new RegExp(symbol.split(''),'g'), '');
console.log(changeNewString)




// function removeSymbols(text, array) {
//     debugger
//    text = prompt('enter some text') 
//    array = prompt('enter some text')
//   let newString = text.slice(array);
//   console.log(array);
